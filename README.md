# Graph-Convolutional-Gaussian-Processes-on-Link-Prediction
...
## Update  
**[2022-10-08]** Code Released. The code is just a prototype, which uses **NO** inducing method to construct both node-wise and edge-wise Gaussian processes. The performance in two datasets:***Texas, Wisconsin*** are just so-so. I will continue to think about it.    
## References  
